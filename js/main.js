...
Example: For "associate SE role requiring ticket completion and testing" → Highlight Webvine experience specifically (completed scoped tickets end to end, wrote and ran UAT)`;
    ...
    function openProjectPanel(projectId) {
        ...
        if (!project || !projectPanelOverlay || !projectPanelTitle || !projectPanelContent)
            return;
    ...
    function openExperiencePanel(experienceId) {
        const experience = experiences.find(e => e.id === experienceId);
        if (!experience || !experiencePanelOverlay || !experiencePanelTitle || !experiencePanelContent)
            return;
